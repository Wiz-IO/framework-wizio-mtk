...
#define TDMA_CURRENT_COUNT         (*(volatile uint16_t *)(TDMA_base+0x0)) /* quater bit counter [13:0] */
#define TDMA_WRAP                  (*(volatile uint16_t *)(TDMA_base+0x4)) /* quater bit wrap    [13:0] */
