...
extern bool MPU_AddRegion(uint32_t RegionStart, uint32_t RegionEnd, bool Cacheable, uint8_t AccessRights);
extern bool MPU_DisableCache(void);
extern void MPU_EnableCache(void);
extern void MPU_RestoreCacheEnState(bool State);
