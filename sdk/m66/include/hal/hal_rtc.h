...
extern bool RTC_LockBBPower(void);
extern bool RTC_UnlockBBPower(void);
extern bool RTC_EnablePowerUp(void);
extern bool RTC_DisablePowerUp(void);
extern bool RTC_IsValidState(void);
extern bool RTC_IsAlarmActive(void);
extern bool RTC_Initialize(void);
extern TDATETIME RTC_GetDateTime(void);
extern bool RTC_SetTime(pTIME Time);
extern bool RTC_SetDate(pDATE Date);
extern TDATETIME RTC_GetAlarmDateTime(void);
extern bool RTC_SetAlarmDateTime(pDATETIME DateTime, bool UseInterrupt);
